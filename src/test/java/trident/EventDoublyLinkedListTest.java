...
public class EventDoublyLinkedListTest {
	...
	{	
		try 
		{
			...
			MethodExecutor executor = JavaAssistUtil.generateMethodExecutor(test, test.getClass().getDeclaredMethod("test", TestEvent.class), false);
			...
			MethodExecutor executor2 = JavaAssistUtil.generateMethodExecutor(test2, test2.getClass().getDeclaredMethod("test", TestEvent.class), false);
			...
			MethodExecutor executor3 = JavaAssistUtil.generateMethodExecutor(test3, test3.getClass().getDeclaredMethod("test", TestEvent.class), false);
			...
			MethodExecutor executor4 = JavaAssistUtil.generateMethodExecutor(test4, test4.getClass().getDeclaredMethod("test", TestEvent.class), false);
			...
			MethodExecutor executor5 = JavaAssistUtil.generateMethodExecutor(test5, test5.getClass().getDeclaredMethod("test", TestEvent.class), false);
			...
			MethodExecutor executor6 = JavaAssistUtil.generateMethodExecutor(test6, test6.getClass().getDeclaredMethod("test", TestEvent.class), false);
			...
			MethodExecutor executor7 = JavaAssistUtil.generateMethodExecutor(test7, test7.getClass().getDeclaredMethod("test", TestEvent.class), false);
	...
	{	
		try 
		{
			...
			{
				list.insert(JavaAssistUtil.generateMethodExecutor(new TestListener("test" + i), test.getClass().getDeclaredMethod("test", TestEvent.class) , false), EventPriority.getByValue(i));
			}
			...
			for(int i = 0; i < iterate; i++)
			{
				...
				EventNode inserted = list.insert(JavaAssistUtil.generateMethodExecutor(new TestListener("test" + i), test.getClass().getDeclaredMethod("test", TestEvent.class), false), EventPriority.getByValue(next));
	...
	public void nextIsNullAndNotHeadRemove()
	{
		try 
		{
			...
			MethodExecutor executor1 = JavaAssistUtil.generateMethodExecutor(test1, test1.getClass().getDeclaredMethod("test", TestEvent.class), false);
